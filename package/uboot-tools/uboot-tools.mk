...
ifeq ($(BR2_PACKAGE_UBOOT_TOOLS_FWUMDATA),y)
UBOOT_TOOLS_MAKE_OPTS += CONFIG_TOOLS_FWUMDATA=y
endif
...
ifeq ($(BR2_PACKAGE_UBOOT_TOOLS_FWUMDATA),y)
define UBOOT_TOOLS_INSTALL_FWUMDATA
	$(INSTALL) -m 0755 -D $(@D)/tools/fwumdata $(TARGET_DIR)/usr/sbin/fwumdata
endef
endif
