...
ROOTFS_ISO9660_BOOTLOADER_CONFIG_PATH = $(BINARIES_DIR)/efi-part/EFI/BOOT/grub.cfg
...
define ROOTFS_ISO9660_PREPARATION
	mkdir -p $(dir $(ROOTFS_ISO9660_BOOTLOADER_CONFIG_PATH))
...
ROOTFS_ISO9660_XORRISO_BOOTLOADER_COMMON_OPTS = -no-emul-boot
